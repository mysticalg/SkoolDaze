...
const closeInventoryPanelBtn = document.getElementById('closeInventoryPanelBtn');
...
const closeSchoolMapBtn = document.getElementById('closeSchoolMapBtn');
...
const closeTradePanelBtn = document.getElementById('closeTradePanelBtn');
